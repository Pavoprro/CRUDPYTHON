...
#5.- Operaciones con el modelo de datos 
    def guardar_producto(self):
        ...
        self.mensaje.setText("El producto a sido registrado!")
    ...
    def actualizar_producto(self):
        ...
        self.mensaje.setText("Producto actualizado correctamente!")

    def eliminar_producto(self):
        self.productodao.producto.clave = self.sku_eliminar.text()  # Usar SKU
    
        self.productodao.eliminarProducto()
        self.mensaje.setText("Producto eliminado correctamente!")
        self.llenar_tabla()
    ...
    def buscar_actualizar(self):
        ...
        if len(datos) == 0:
            ...
            self.sku_actualizar.setText(datos[0][1])  # SKU
            self.descripcion_actualizar.setText(datos[0][2])  # Descripción
            self.existencia_actualizar.setText(str(datos[0][3]))  # Existencia
            self.precio_actualizar.setText(str(datos[0][4]))  # Precio
    ...
    def buscar_eliminar(self):
        ...
        if len(datos) == 0:
            ...
            # Llenar campos de actualizar con los datos encontrados
            self.sku_eliminar.setText(datos[0][1])  # SKU
            self.descripcion_eliminar.setText(datos[0][2])  # Descripción
            self.existencia_eliminar.setText(str(datos[0][3]))  # Existencia
